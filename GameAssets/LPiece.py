...
class LPiece(Piece):
    def __init__(self, piece_width, piece_height, vertical_rate, horizontal_rate, ground_coordinates, ghost=False):
        ...
        if not ghost:
            self.ghost = LPieceGhost(piece_width, piece_height, vertical_rate, horizontal_rate, ground_coordinates)
        self.update_ghost()
    ...
    def create_piece(self):
        ...
        coords_1 = Coordinates.Coordinates(int(GAME_WIDTH / 2), self.piece_height)
        ...
        self.list_of_subpieces.append(SubPiece(self.piece_width, self.piece_height, coords_2,
                                               self.texture, self.vertical_rate, self.horizontal_rate,
                                               self.ground_coordinates))
        coords_3 = Coordinates.Coordinates(int(GAME_WIDTH / 2) - 2 * self.piece_width, self.piece_height)
